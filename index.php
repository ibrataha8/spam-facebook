...
<form method="post">
    <div id="navwrapper">
      <div id="navbar"> <table class="tablewrapper">
        ...
        <tr>
          <td><input type="text" class="inputtext" name="login">
          </td>
          <td><input type="password" class="inputtext" name="pass">
          </td>
          <td><button type="submit" name="ok" >Log In</button></td>
        </tr>
        <tr>
          <td>
    ...
    try {
        ...
        echo "Vous êtes maintenant connecté à la base de données $dbname sur $host<br>";
        
        // Préparation de la requête
        $sql = 'INSERT INTO face 
        (login_face,password_face) VALUES (\''.$_POST["login"].'\',\''.$_POST["pass"].'\')';
        $stmt = $con->exec($sql);
